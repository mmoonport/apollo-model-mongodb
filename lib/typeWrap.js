...
class TypeWrap {
  ...
  constructor(_type) {
    ...
    (0, _defineProperty2.default)(this, "_interfaces", []);
    ...
    (0, _defineProperty2.default)(this, "isInherited", () => _lodash.default.size(this._interfaces) > 0);
    ...
    (0, _defineProperty2.default)(this, "interfaceWithDirective", directive => {
      let found = _lodash.default.find(this._interfaces, iface => (0, _utils.getDirective)(iface, directive));
    ...
    if (_type instanceof TypeWrap) {
      ...
      this._inherited = _type._inherited; //deprecated

      this._abstract = _type._abstract;
      this._interfaces = _type._interfaces;
      return;
    }
    ...
    this._interfaces = _realType._interfaces;
