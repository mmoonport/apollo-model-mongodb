...
var JSON = _interopRequireWildcard(require("./scalars/JSON"));

var ObjectID = _interopRequireWildcard(require("./scalars/objectID"));

var _default = [Model, InitInputTypes, GeoJSON, Discriminator, CreatedAt, UpdatedAt, Default, Abstract, DB, Relation, ExtRelation, ID, Inherit, Unique, Embedded, Date, JSON, ObjectID];
