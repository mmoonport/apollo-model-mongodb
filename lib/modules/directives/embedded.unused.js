...
exports.schemaDirectives = exports.typeDef = exports.INPUT_UPDATE_MANY_REQUIRED_EMBEDDED = exports.INPUT_UPDATE_ONE_REQUIRED_EMBEDDED = exports.INPUT_UPDATE_MANY_EMBEDDED = exports.INPUT_UPDATE_ONE_EMBEDDED = exports.INPUT_CREATE_MANY_EMBEDDED = exports.INPUT_CREATE_ONE_EMBEDDED = void 0;
...
const typeDef = `directive @embedded on OBJECT`;
...
class EmbeddedDirective extends _graphqlTools.SchemaDirectiveVisitor {
  ...
  visitFieldDefinition(field, {
    ...
    if (!((0, _utils.getDirective)(fieldTypeWrap.realType(), 'embedded') || fieldTypeWrap.interfaceWithDirective('embedded'))) {
