...
var _typeWrap2 = _interopRequireDefault(require("../typeWrap"));
...
class InputTypesClass {
  constructor(SchemaTypes) {
    ...
    (0, _defineProperty2.default)(this, "_validateDirectivesForNestedObjects", field => {
      let fieldTypeWrap = new _typeWrap2.default(field.type);
    ...
    (0, _defineProperty2.default)(this, "_defaultTransformNested", ({
      ...
      return [{
        ...
        Transforms.validateAndTransformNestedInput(type, fieldTypeWrap.isMany()), !isCreate && fieldTypeWrap.isNested() ? params => !Array.isArray(_lodash.default.head(Object.values(params))) ? Transforms.flattenNested(params) : params : null])
      }];
    });
    ...
    (0, _defineProperty2.default)(this, "_createInputWithWhereNested", ({
      ...
      let typeWrap = new _typeWrap2.default(initialType);
      let newType = new _graphql.GraphQLInputObjectType({
        name,
        fields: {
          where: {
