  ...
  constructor({
    ...
    (0, _defineProperty2.default)(this, "_createAllQuery", modelType => {
      ...
      this.Query._fields[name] = {
        ...
        resolve: async (parent, args, context) => {
          let selector = await (0, _utils2.applyInputTransform)(context)(args.where, whereType);
    ...
    (0, _defineProperty2.default)(this, "_createConnectionQuery", modelType => {
      ...
      this.Query._fields[name] = {
        ...
        resolve: async (parent, args, context) => {
          return {
            _selector: await (0, _utils2.applyInputTransform)(context)(args.where, whereType),
            _skip: args.skip,
            _limit: args.first
          };
        }
    ...
    (0, _defineProperty2.default)(this, "_createSingleQuery", modelType => {
      ...
      this.Query._fields[name] = {
        ...
        name,
        resolve: async (parent, args, context) => {
          let selector = await (0, _utils2.applyInputTransform)(context)(args.where, whereUniqueType); // let entries = Object.entries(selector);
    ...
    (0, _defineProperty2.default)(this, "_createCreateMutation", modelType => {
      ...
      this.Mutation._fields[name] = {
        ...
        resolve: async (parent, args, context) => {
          ...
          //   KIND.CREATE_ALWAYS
          // );
          let doc = await (0, _utils2.applyInputTransform)(context)(args.data, inputType);
      ...
      this.Mutation._fields[name] = {
        ...
        resolve: async (parent, args, context) => {
          ...
          if (found) {
            ...
            let doc = await (0, _utils2.applyInputTransform)(context)(foundData, inputType);
    ...
    (0, _defineProperty2.default)(this, "_createDeleteMutation", modelType => {
      ...
      this.Mutation._fields[name] = {
        ...
        name,
        resolve: async (parent, args, context) => {
          let selector = await (0, _utils2.applyInputTransform)(context)(args.where, whereUniqueType);
    ...
    (0, _defineProperty2.default)(this, "_createUpdateMutation", modelType => {
      ...
      this.Mutation._fields[name] = {
        ...
        resolve: async (parent, args, context) => {
          ...
          let data = await (0, _utils2.applyInputTransform)(context)(args.data, updateType);
          let {
            doc,
            validations,
            arrayFilters,
